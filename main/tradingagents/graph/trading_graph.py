...
class TradingAgentsGraph:
    """Main class that orchestrates the trading agents framework (Gemini-only)."""
    ...
    def __init__(
        ...
        # ✅ Initialize Gemini LLMs (objects created in main.py)
        self.deep_thinking_llm = self.config["deep_think_llm"]
        self.quick_thinking_llm = self.config["quick_think_llm"]

        # ✅ Initialize memories using Gemini
    ...
    def _log_state(self, trade_date, final_state):
        ...
        with open(f"eval_results/{self.ticker}/TradingAgentsStrategy_logs/full_states_log_{trade_date}.json", "w") as f:
